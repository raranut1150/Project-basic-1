...
function Navbar() {
  ...
  return (
    <div className=" w-[90vw]  md:max-w-[1100px] h-28  m-auto flex justify-between items-center relative">
      <div>
      ...
      <div
        className={
          !isOpen
            ? "absolute top-[-180px] flex-col w-full opacity-0 transition-all ease-in-out duration-300 text-center"
            : "absolute top-[110px]  w-full h-full transition-all ease-in-out duration-300 text-center"
        }
      >
          <ul className="flex-col text-[#090f4e] text-lg space-y-5 mb-5">
            <li>
              <a
                href="#"
