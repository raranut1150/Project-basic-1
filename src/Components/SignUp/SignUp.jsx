...
function SignUp() {
  return (
    <div className="mx-auto max-w-6xl bg-[#E7F5FF] sm:p-20 py-8 rounded-[30px]">
      <div className="flex flex-col justify-center items-center mx-4 max-w-[480px] sm:mx-auto">
